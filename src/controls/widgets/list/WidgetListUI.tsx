...
export const WidgetList_LineUI = observer(function WidgetList_LineUI_<T extends Schema>(p: {
...
export const WidgetListUI = observer(function WidgetListUI_<T extends Schema>(p: { widget: Widget_list<T> }) {
