// import { Button, Menu, MenuItem, MenuList, MenuPopover, MenuTrigger } from 'rsuite'
...
export const HasProblem = <I.ExpiredRound color='red' />
export const IsOK = <I.CheckRound color='green' />
