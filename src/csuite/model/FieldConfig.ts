...
export type FieldConfigFor<FIELD extends Field> = FieldConfig_CommonProperties<FIELD> & FIELD['z$OwnConfig']
...
export interface FieldConfig_CommonProperties<out FIELD extends Field> {
    ...
    * @stability beta
    */
   beforeInit?(serial: unknown /* FIELD['z$Serial'] */): FIELD['z$Serial']
   version?: string
