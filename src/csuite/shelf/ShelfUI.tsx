...
const _BasicShelfUI = observer(function BasicShelf({
   // own props
   anchor,
   defaultSize,
   floating = false,
...
const BasicShelfContentUI = observer(function BasicShelfContentUI_(p: React.HTMLAttributes<HTMLDivElement>) {
