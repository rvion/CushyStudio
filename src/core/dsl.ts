...
export class Comfy extends rt.ComfyBase {
    ...
    sampling_KSampler = (args: KSampler_input, uid?: rt.NodeUID) => new KSampler(this, uid, args)
    loaders_CheckpointLoader = (args: CheckpointLoader_input, uid?: rt.NodeUID) =>
        new CheckpointLoader(this, uid, args)
    loaders_CheckpointLoaderSimple = (args: CheckpointLoaderSimple_input, uid?: rt.NodeUID) =>
        new CheckpointLoaderSimple(this, uid, args)
    conditioning_CLIPTextEncode = (args: CLIPTextEncode_input, uid?: rt.NodeUID) =>
        new CLIPTextEncode(this, uid, args)
    conditioning_CLIPSetLastLayer = (args: CLIPSetLastLayer_input, uid?: rt.NodeUID) =>
        new CLIPSetLastLayer(this, uid, args)
    latent_VAEDecode = (args: VAEDecode_input, uid?: rt.NodeUID) => new VAEDecode(this, uid, args)
    latent_VAEEncode = (args: VAEEncode_input, uid?: rt.NodeUID) => new VAEEncode(this, uid, args)
    latent_inpaint_VAEEncodeForInpaint = (args: VAEEncodeForInpaint_input, uid?: rt.NodeUID) =>
        new VAEEncodeForInpaint(this, uid, args)
    loaders_VAELoader = (args: VAELoader_input, uid?: rt.NodeUID) => new VAELoader(this, uid, args)
    latent_EmptyLatentImage = (args: EmptyLatentImage_input, uid?: rt.NodeUID) =>
        new EmptyLatentImage(this, uid, args)
    latent_LatentUpscale = (args: LatentUpscale_input, uid?: rt.NodeUID) => new LatentUpscale(this, uid, args)
    image_SaveImage = (args: SaveImage_input, uid?: rt.NodeUID) => new SaveImage(this, uid, args)
    image_LoadImage = (args: LoadImage_input, uid?: rt.NodeUID) => new LoadImage(this, uid, args)
    image_LoadImageMask = (args: LoadImageMask_input, uid?: rt.NodeUID) => new LoadImageMask(this, uid, args)
    image_ImageScale = (args: ImageScale_input, uid?: rt.NodeUID) => new ImageScale(this, uid, args)
    image_ImageInvert = (args: ImageInvert_input, uid?: rt.NodeUID) => new ImageInvert(this, uid, args)
    conditioning_ConditioningCombine = (args: ConditioningCombine_input, uid?: rt.NodeUID) =>
        new ConditioningCombine(this, uid, args)
    conditioning_ConditioningSetArea = (args: ConditioningSetArea_input, uid?: rt.NodeUID) =>
        new ConditioningSetArea(this, uid, args)
    sampling_KSamplerAdvanced = (args: KSamplerAdvanced_input, uid?: rt.NodeUID) =>
        new KSamplerAdvanced(this, uid, args)
    latent_inpaint_SetLatentNoiseMask = (args: SetLatentNoiseMask_input, uid?: rt.NodeUID) =>
        new SetLatentNoiseMask(this, uid, args)
    latent_LatentComposite = (args: LatentComposite_input, uid?: rt.NodeUID) =>
        new LatentComposite(this, uid, args)
    latent_LatentRotate = (args: LatentRotate_input, uid?: rt.NodeUID) => new LatentRotate(this, uid, args)
    latent_LatentFlip = (args: LatentFlip_input, uid?: rt.NodeUID) => new LatentFlip(this, uid, args)
    latent_LatentCrop = (args: LatentCrop_input, uid?: rt.NodeUID) => new LatentCrop(this, uid, args)
    loaders_LoraLoader = (args: LoraLoader_input, uid?: rt.NodeUID) => new LoraLoader(this, uid, args)
    loaders_CLIPLoader = (args: CLIPLoader_input, uid?: rt.NodeUID) => new CLIPLoader(this, uid, args)
    conditioning_ControlNetApply = (args: ControlNetApply_input, uid?: rt.NodeUID) =>
        new ControlNetApply(this, uid, args)
    loaders_ControlNetLoader = (args: ControlNetLoader_input, uid?: rt.NodeUID) =>
        new ControlNetLoader(this, uid, args)
    loaders_DiffControlNetLoader = (args: DiffControlNetLoader_input, uid?: rt.NodeUID) =>
        new DiffControlNetLoader(this, uid, args)
    loaders_T2IAdapterLoader = (args: T2IAdapterLoader_input, uid?: rt.NodeUID) =>
        new T2IAdapterLoader(this, uid, args)
    _for_testing_VAEDecodeTiled = (args: VAEDecodeTiled_input, uid?: rt.NodeUID) =>
        new VAEDecodeTiled(this, uid, args)
}
