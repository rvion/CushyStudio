...
export class TreeFavoriteApps implements ITreeEntry {
    ...
    children = (): ITreeElement<CushyAppID>[] => {
        return cushy.favoriteApps.map((app): ITreeElement<CushyAppID> => ({ ctor: TreeApp, key: app.id, props: app.id }))
    }
}
...
export class TreeFavoriteDrafts implements ITreeEntry {
    ...
    children = (): ITreeElement<DraftL>[] => {
        return cushy.favoriteDrafts.map((draft): ITreeElement<DraftL> => ({ ctor: TreeDraft, key: draft.id, props: draft }))
    }
}
