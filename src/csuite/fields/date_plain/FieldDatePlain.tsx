...
// #region State
export class Field_datePlain<const NULLABLE extends boolean = false> extends Field<
   Field_datePlain_types<NULLABLE>
> {
   // #region static
   ...
   readonly DefaultHeaderUI:
      | CovariantFC<{ field: Field_datePlain<NULLABLE>; readonly?: boolean }>
      | undefined = WidgetDatePlain_HeaderUI<NULLABLE>
