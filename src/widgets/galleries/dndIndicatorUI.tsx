...
export class CushyDnDHandler {
   ...
   setContent({ suffixIcon, icon, label, content }: ExplanationAboutWhatIsBeeingDragged): void {
      runInAction(() => {
   ...
   /**
    * Call this when starting a drag to have the indicator have a
    * fallback when the normal content is cleared
    */
