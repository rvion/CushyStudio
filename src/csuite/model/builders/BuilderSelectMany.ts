...
export class BuilderSelectMany<Schemaᐸ_ᐳ extends SchemaAndAliasesᐸ_ᐳ> extends BaseBuilder<Schemaᐸ_ᐳ> {
     ...
     */
    selectMany = <const V, const K extends string>(config: Field_selectMany_config<V, K>): Apply<Schemaᐸ_ᐳ['Many'], V, K> => {
     ...
     * @see {@link selectManyOptionValues}
     */
    selectMany_ = <const V, const K extends string>(config: Field_selectMany_config<V, K>): Apply<Schemaᐸ_ᐳ['Many'], V, K> => {
        return this.buildSchema(Field_selectMany<V, K>, {
            ...this._defaultSelectManyConfig,
            ...config,
        })
