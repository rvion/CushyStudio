...
export const ShellCushyLeftUI = observer(function ShellCushyLeft(p: CompiledSlotList) {
    const field = p.field
...
export const ShellCushyRightUI = observer(function ShellCushyRight(p: CompiledSlotList) {
    const field = p.field
    const originalField = field /* 🔴 */
    const utils = p.presenter.utils
...
export const ShellCushyFluidUI = observer(function ShellCushyFluid(p: CompiledSlotList) {
    const field = p.field
    const originalField = field /* 🔴 */
    const utils = p.presenter.utils
...
const CushyShellUI = observer(function CushySHell(p: CompiledSlotList & { HEADER: ReactNode }) {
    const field = p.field
    const utils = p.presenter.utils
