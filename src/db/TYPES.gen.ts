...
export const schemas = {
    migrations: new T.TableInfo('migrations', 'Migrations', MigrationsFields, MigrationsSchema),
    users: new T.TableInfo('users', 'Users', UsersFields, UsersSchema),
    graph: new T.TableInfo('graph', 'Graph', GraphFields, GraphSchema),
    draft: new T.TableInfo('draft', 'Draft', DraftFields, DraftSchema),
    project: new T.TableInfo('project', 'Project', ProjectFields, ProjectSchema),
    step: new T.TableInfo('step', 'Step', StepFields, StepSchema),
    comfy_prompt: new T.TableInfo('comfy_prompt', 'ComfyPrompt', ComfyPromptFields, ComfyPromptSchema),
    comfy_schema: new T.TableInfo('comfy_schema', 'ComfySchema', ComfySchemaFields, ComfySchemaSchema),
    media_text: new T.TableInfo('media_text', 'MediaText', MediaTextFields, MediaTextSchema),
    media_video: new T.TableInfo('media_video', 'MediaVideo', MediaVideoFields, MediaVideoSchema),
    media_image: new T.TableInfo('media_image', 'MediaImage', MediaImageFields, MediaImageSchema),
    ...
    runtime_error: new T.TableInfo('runtime_error', 'RuntimeError', RuntimeErrorFields, RuntimeErrorSchema),
    media_splat: new T.TableInfo('media_splat', 'MediaSplat', MediaSplatFields, MediaSplatSchema),
    custom_data: new T.TableInfo('custom_data', 'CustomData', CustomDataFields, CustomDataSchema),
    cushy_script: new T.TableInfo('cushy_script', 'CushyScript', CushyScriptFields, CushyScriptSchema),
    cushy_app: new T.TableInfo('cushy_app', 'CushyApp', CushyAppFields, CushyAppSchema),
}
