...
export const STYLE_GROUPS = {
   ...
   ArtStyles: {
      ...
      Painting: [ 'Impressionism', 'Surrealism', 'Cubism', 'Abstract', 'Expressionism', 'Pop Art', 'Dada', 'Futurism', 'Art Nouveau', 'Art Deco', 'Suprematism', 'Pointillism', 'Symbolism', 'Romanticism', 'Neoclassicism', 'Renaissance', 'Mannerism', 'Gothic', ],
   },
}
