import type { BoxBasicProps } from 'src/cushy-forms/src/csuite/box/BoxUIProps'
...
import {
   ...
   type IconName,
   IkonOf,
   registerComponentAsClonableWhenInsideReveal,
   ...
   forwardRef(function Dov_(p: DovProps, ref: ForwardedRef<HTMLDivElement>) {
      ...
      return (
         ...
         >
            ...
            {loading && (
               <div tw='loading loading-spinner absolute loading-sm self-center justify-self-center' />
            )}
         </Elem>
      )
   }),
