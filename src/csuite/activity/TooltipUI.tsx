...
export const TooltipUI = observer(function TooltipUI_(p: {}) {
   ...
   return (
      // z-index must be more than the value from RevealUI
      <div style={pos} tw='absolute whitespace-pre rounded [z-index:999999999]' ref={shellRef}>
         <Frame base={80} border shadow tw='w-fit px-1 py-0.5 opacity-70'>
            <div>{txt}</div>
         </Frame>
      </div>
   )
