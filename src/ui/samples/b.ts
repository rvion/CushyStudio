...
export class Comfy extends ComfyFlow {
    ...
    CLIPTextEncode = (args: CLIPTextEncode_input, uid?: NodeUID) => new CLIPTextEncode(this, uid, args)
    CLIPSetLastLayer = (args: CLIPSetLastLayer_input, uid?: NodeUID) => new CLIPSetLastLayer(this, uid, args)
    VAEDecode = (args: VAEDecode_input, uid?: NodeUID) => new VAEDecode(this, uid, args)
    VAEEncode = (args: VAEEncode_input, uid?: NodeUID) => new VAEEncode(this, uid, args)
    VAEEncodeForInpaint = (args: VAEEncodeForInpaint_input, uid?: NodeUID) => new VAEEncodeForInpaint(this, uid, args)
    VAELoader = (args: VAELoader_input, uid?: NodeUID) => new VAELoader(this, uid, args)
    EmptyLatentImage = (args: EmptyLatentImage_input, uid?: NodeUID) => new EmptyLatentImage(this, uid, args)
    LatentUpscale = (args: LatentUpscale_input, uid?: NodeUID) => new LatentUpscale(this, uid, args)
    SaveImage = (args: SaveImage_input, uid?: NodeUID) => new SaveImage(this, uid, args)
    LoadImage = (args: LoadImage_input, uid?: NodeUID) => new LoadImage(this, uid, args)
    LoadImageMask = (args: LoadImageMask_input, uid?: NodeUID) => new LoadImageMask(this, uid, args)
    ImageScale = (args: ImageScale_input, uid?: NodeUID) => new ImageScale(this, uid, args)
    ImageInvert = (args: ImageInvert_input, uid?: NodeUID) => new ImageInvert(this, uid, args)
    ConditioningCombine = (args: ConditioningCombine_input, uid?: NodeUID) => new ConditioningCombine(this, uid, args)
    ConditioningSetArea = (args: ConditioningSetArea_input, uid?: NodeUID) => new ConditioningSetArea(this, uid, args)
    KSamplerAdvanced = (args: KSamplerAdvanced_input, uid?: NodeUID) => new KSamplerAdvanced(this, uid, args)
    SetLatentNoiseMask = (args: SetLatentNoiseMask_input, uid?: NodeUID) => new SetLatentNoiseMask(this, uid, args)
    LatentComposite = (args: LatentComposite_input, uid?: NodeUID) => new LatentComposite(this, uid, args)
    LatentRotate = (args: LatentRotate_input, uid?: NodeUID) => new LatentRotate(this, uid, args)
    LatentFlip = (args: LatentFlip_input, uid?: NodeUID) => new LatentFlip(this, uid, args)
    LatentCrop = (args: LatentCrop_input, uid?: NodeUID) => new LatentCrop(this, uid, args)
    LoraLoader = (args: LoraLoader_input, uid?: NodeUID) => new LoraLoader(this, uid, args)
    CLIPLoader = (args: CLIPLoader_input, uid?: NodeUID) => new CLIPLoader(this, uid, args)
    ControlNetApply = (args: ControlNetApply_input, uid?: NodeUID) => new ControlNetApply(this, uid, args)
    ControlNetLoader = (args: ControlNetLoader_input, uid?: NodeUID) => new ControlNetLoader(this, uid, args)
    DiffControlNetLoader = (args: DiffControlNetLoader_input, uid?: NodeUID) => new DiffControlNetLoader(this, uid, args)
    T2IAdapterLoader = (args: T2IAdapterLoader_input, uid?: NodeUID) => new T2IAdapterLoader(this, uid, args)
    VAEDecodeTiled = (args: VAEDecodeTiled_input, uid?: NodeUID) => new VAEDecodeTiled(this, uid, args)
