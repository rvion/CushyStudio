...
export const WidgetShared_LineUI = observer(function WidgetBoolUI_<T extends Widget>(p: { widget: Widget_shared<T> }) {
...
export const WidgetShared_BlockUI = observer(function WidgetBoolUI_<T extends Widget>(p: { widget: Widget_shared<T> }) {
    // if (p.widget.shared.serial.collapsed) return <WidgetWithLabelUI rootKey={p.widget.config.rootKey} widget={p.widget.shared} />
