...
export type DovProps = {
   ...
   // logic --------------------------------------------------
   /** TODO: */
   triggerOnPress?: { startingState: boolean; toggleGroup: string }
   // STATES MODIFIERS ------------------------------------------------
...
export const Dov = observer(
   forwardRef(function Dov_(p: DovProps, ref: ForwardedRef<HTMLDivElement>) {
      ...
      const {
            ...
            onMouseDown, onMouseEnter: onMouseEnter__, onClick, triggerOnPress, // interactions
